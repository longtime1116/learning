...
- [A Tour of Go](https://go-tour-jp.appspot.com/list)[ソースコード](https://github.com/longtime1116/go_sandbox/tour)
  - Go を学びたい学びたいとずっと思っていたのでようやく取り組むことにした。
  - 仕事でも今後使うかもしれないので、そのときに備えて爪を研いでおく。
...
- ニューヨーク発最強英語発音メソッド
  ...
  - 読んだが、この本は完全に言語化が下手なのでこの本が期待する通りに読者が何かを学び取ることは基本的に無理だと思う。ババロアみたいな感じにするとか、ヤンキーみたいな口にするとか、そういう表現に頼りすぎている。
...
# 読み中
- How Google Works
  - 良いエンジニアリング組織を作っていく上でGoogleのやり方を学んでおくのは大きな価値があるはずだと思ったので読むことにした。今の自分の考えを覆すような発想を得られたり仕組みを知れたりしたら嬉しい。
- Goならわかるシステムプログラミング
