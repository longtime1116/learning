...
## 13.3
* 「無効化すべき時にだけ無効化する」←これができるならいいが、それが難しい
...
# 感想
* 1年以上かかったが、読んでよかった。ドメイン駆動設計の言葉を使うと自分のなかでの理想的な世界を明瞭に言語化することができるので、自身の思考の整理の役に立つし、チームの人とコミュニケーションを撮る上でも役に立つ。
* メッセージングをちゃんと使ったサービスは自分で作ってみたいなと思った。
